...
export interface DirectorUiState {
  ...
  /** When true, toolbar/panel panorama file import is disabled (host-provided material). */
  panoramaImportLocked: boolean;
  /** Local preview toggle — hides panorama in viewport without removing the asset. */
  panoramaPreviewVisible: boolean;
}
...
export interface DirectorActions {
  ...
  setPanoramaImportLocked: (locked: boolean) => void;
  setPanoramaPreviewVisible: (visible: boolean) => void;
  togglePanoramaPreviewVisible: () => void;
...
function extractPersistedDirectorState(state: DirectorRuntimeState): DirectorState {
  return cloneJsonValue({
    ...
    panoramaImportLocked: state.panoramaImportLocked,
...
export const useDirectorStore = create<DirectorStore>((set, get) => {
  ...
  return {
    ...
    setPanoramaImportLocked: (locked) =>
      commitUiMutation((state) => ({
        ...state,
        panoramaImportLocked: locked,
      })),
    setPanoramaPreviewVisible: (visible) =>
      commitUiMutation((state) => ({
        ...state,
        panoramaPreviewVisible: visible,
      })),
    togglePanoramaPreviewVisible: () =>
      commitUiMutation((state) => ({
        ...state,
        panoramaPreviewVisible: !state.panoramaPreviewVisible,
      })),
