...
import ue4MannequinModelUrl from "../../../assets/models/ue-mannequin-retopology.glb?url";
...
/**
 * Bundled UE mannequin GLB.
 * App/docs: Vite emits a URL. Library build: inlined as data URL (Vite lib mode).
 */
export const UE4_MANNEQUIN_MODEL_URL = ue4MannequinModelUrl;
