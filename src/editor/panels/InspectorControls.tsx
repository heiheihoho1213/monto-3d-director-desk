...
export function InspectorColorField({
  ...
  // Native color pickers often live outside the page, so window pointerup never fires
  // while dragging. Commit shortly after input events stop (= drag ended / finger up).
  ...
  const scheduleCommitAfterDrag = useCallback(() => {
    clearCommitTimer();
